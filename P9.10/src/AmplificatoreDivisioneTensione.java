/**
 * AmplificatoreDivisioneTensione
 * @author Thomas Giora
 */
public class AmplificatoreDivisioneTensione extends Amplificatore {
     ...
     */
    public AmplificatoreDivisioneTensione(double v1, double r1, double r2) {
        super(v1);
        this.r1 = r1;
        this.r2 = r2;
    }//AmplificatoreDivisioneTensione
